...
export default class Car {
    ...
    setWheels() {
        ...
        this.car.addWheel({
                ...
                chassisConnectionPointLocal: new CANNON.Vec3(1.4600000000000009, 0.1, -1.8499999999999996),
        ...
        this.car.addWheel({
                ...
                rollInfluence:  0.01,
                axleLocal: new CANNON.Vec3(-1, 0, 0),
                chassisConnectionPointLocal: new CANNON.Vec3(-1.459999999999999, 0.1, -1.83),
                maxSuspensionTravel: 1,
                customSlidingRotationalSpeed: 30,
            });
        this.car.addWheel({
                ...
                rollInfluence:  0.01,
                axleLocal: new CANNON.Vec3(-1, 0, 0),
                chassisConnectionPointLocal: new CANNON.Vec3(1.4600000000000009, 0.1, 2.66),
                maxSuspensionTravel: 1,
                customSlidingRotationalSpeed: 30,
            });
        this.car.addWheel({
                ...
                rollInfluence:  0.01,
                axleLocal: new CANNON.Vec3(-1, 0, 0),
                chassisConnectionPointLocal: new CANNON.Vec3(-1.459999999999999, 0.1, 2.66),
                maxSuspensionTravel: 1,
                customSlidingRotationalSpeed: 30,
            });

...
export default class Car {
    ...
    setWheels() {
        ...
        this.car.addWheel({
                ...
                chassisConnectionPointLocal: new CANNON.Vec3(1.370000000000001, 0.1899999999999995, -2.1499999999999995),
        ...
        this.car.addWheel({
                ...
                rollInfluence:  0.01,
                axleLocal: new CANNON.Vec3(-1, 0, 0),
                chassisConnectionPointLocal: new CANNON.Vec3(-1.3699999999999992, 0.1899999999999995, -2.1499999999999995),
                maxSuspensionTravel: 1,
                customSlidingRotationalSpeed: 30,
            });
        this.car.addWheel({
                ...
                rollInfluence:  0.01,
                axleLocal: new CANNON.Vec3(-1, 0, 0),
                chassisConnectionPointLocal: new CANNON.Vec3(1.370000000000001, 0.1899999999999995, 1.75),
                maxSuspensionTravel: 1,
                customSlidingRotationalSpeed: 30,
            });
        this.car.addWheel({
                ...
                rollInfluence:  0.01,
                axleLocal: new CANNON.Vec3(-1, 0, 0),
                chassisConnectionPointLocal: new CANNON.Vec3(-1.3699999999999992, 0.1899999999999995, 1.75),
                maxSuspensionTravel: 1,
                customSlidingRotationalSpeed: 30,
            });
    ...
    controls() {
        ...
        const hindMovement = () => {
            ...
            if(!keysPressed.includes("shift") && !keysPressed.includes(" ")){
